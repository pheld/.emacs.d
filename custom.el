...
(custom-set-faces
 ...
 '(term-color-blue ((t (:background "blue2" :foreground "#89BDFF"))))
 '(term-color-cyan ((t (:background "cyan3" :foreground "#ae81ff"))))
 '(term-color-green ((t (:background "green3" :foreground "#a6e22e"))))
 '(term-color-magenta ((t (:background "magenta3" :foreground "#fd5ff1"))))
 '(term-color-red ((t (:background "red3" :foreground "#f92672"))))
 '(term-color-white ((t (:background "white" :foreground "#e6e6e6"))))
 '(term-color-yellow ((t (:background "yellow3" :foreground "#e6db74"))))
